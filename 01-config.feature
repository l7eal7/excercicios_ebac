...
# ==========================================================
  ...
  Cenário: Seleções obrigatórias devem ser feitas antes de adicionar ao carrinho
    Dado que tento adicionar ao carrinho sem selecionar cor, tamanho ou quantidade
  ...
  Esquema do Cenário: Quantidade válida (1 a 10 unidades)
    Dado que seleciono a cor "<cor>", tamanho "<tamanho>" e a quantidade "<quantidade>"
    Quando clico em "Adicionar ao carrinho"
  ...
  Cenário: Quantidade acima de 10 não deve ser permitida
    Dado que seleciono a cor "preto" e tamanho "M"
  ...
  Cenário: Botão limpar deve restaurar o estado inicial
    Dado que seleciono a cor "azul", tamanho "G" e quantidade "3"
    Quando clico no botão "Limpar"
    Então a seleção de cor e tamanho deve ser limpa
    E quantidade deve voltar ao padrão (1)
